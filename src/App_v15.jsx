...
function App() {
  ...
  const downloadPoster = () => {
    ...
    link.download = `海报_${selectedTemplate}_${Date.now()}.png`
    link.href = canvas.toDataURL()
    link.click()
  }

  // 使用useEffect在组件加载和状态变化时重新绘制海报
  useEffect(() => {
    drawPoster()
    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600">专业级海报设计，一键生成高质量营销素材</p>
        </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div>
                    <Label htmlFor="template">选择商品布局模板</Label>
                  ...
                  <div>
                    <Label htmlFor="style">选择整体风格</Label>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div>
                    <Label htmlFor="qrCode">二维码上传</Label>
                    <Input
                      id="qrCode"
                      type="file"
                      accept="image/*"
                ...
                {showImport && (
                  <div className="mb-6 p-4 border rounded-lg bg-gray-50">
                    ...
                    <p className="text-sm text-gray-600 mb-2">
                      请按照格式：商品标题,商品规格,生产日期,划线价,促销价,商品图片链接
                    </p>
                    <textarea
                      id="csvData"
                    ...
                    <div className="flex gap-2 mt-3">
                      ...
                      <Button variant="outline" onClick={() => setShowImport(false)} size="sm">
                        取消
                      </Button>
                    </div>
                  </div>
                  ...
                  {products.map((product, index) => (
                    <div key={product.id} className="p-4 border rounded-lg">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          <Label htmlFor={`title-${index}`}>商品名称</Label>
                          <Input
                            id={`title-${index}`}
                            value={product.title}
                        ...
                        <div>
                          <Label htmlFor={`date-${index}`}>生产日期</Label>
                          <Input
                            id={`date-${index}`}
                            type="date"
